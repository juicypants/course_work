...
Student::Student(const char* const name, const int student_id, const double gpa): max_credit {STUDENT_INIT_MAX_CREDIT},
    curr_credit {0}, num_enrolled_course{0}, pending_credit{0}, swap_list{new Swap_List}{
