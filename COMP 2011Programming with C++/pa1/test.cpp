...
int main()
{   /*
    char handA[6] = {'*','!','J','Q','A','K'};
    int handAn[6] = {};
    
    bool a = isContinuous(handA, 6, handAn);
    cout <<"a is "<< a << endl;
    */
    ...
    int valueA;
    int valueB;
    char handC[5] = {'2','3','2','3','4'};
    int handCn[5] = {};
    char handB[5] = {'J','*','Q','J','6'};
    bool c = isContinuous(handC, 5, handCn);
    cout<< "isitastraight " << c << endl;
    compareValue(handC, handB, valueA, valueB);
    cout<< "valueA " << valueA << "valueB " << valueB;
